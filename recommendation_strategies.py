...
class GenreBasedStrategy(RecommendationStrategy):
    ...
    def recommend(self, perfil, catalogo_completo, num_recomendacoes=5):
        ...
        # MUDANÇA: Adicionado try...except para o caso de 'catalogo_completo.midias' estar vazio ou inválido
        try:
            ...
            print(f"Erro ao acessar dados do perfil ou catálogo: {e}")
        except ValueError as e: # Captura erro do random.sample se a lista estiver vazia
             print(f"Erro ao gerar amostra de recomendações: {e}")
        except Exception as e:
            print(f"Erro inesperado na estratégia baseada em gênero: {e}")
...
class TrendingStrategy(RecommendationStrategy):
    ...
    def recommend(self, perfil, catalogo_completo, num_recomendacoes=5):
        ...
        try:
            ...
            print(f"Erro inesperado na estratégia 'Trending': {e}")
...
class SurpriseMeStrategy(RecommendationStrategy):
    ...
    def recommend(self, perfil, catalogo_completo, num_recomendacoes=5):
        ...
        # MUDANÇA: Adicionado try...except
        try:
            # if not catalogo_completo.midias: # Esta checagem é feita implicitamente abaixo
            #     print("O catálogo está vazio no momento.")
            #     return
            ...
            print(f"Erro inesperado na estratégia 'SurpriseMe': {e}")